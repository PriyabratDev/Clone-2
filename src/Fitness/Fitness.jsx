...
import "../src/Fitness/Fitness.css";
import SimpleSlider from "../src/Fitness/FitnessSlider";
import SimpleSlider2 from "../src/Fitness/FitnessSlider2";
import { Navbar2 } from "../src/Fitness/Navbar2";
...
const Fitness = () => {
  ...
  return loading__Status ? (
    ...
    <div>
      {/* <Navbar path="fitness" /> Import Navbar from Navbar.jsx */}
